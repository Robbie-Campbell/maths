...
trig_or_pythagoras = input("Do you want to do trigonomety or pythagoras?(t/p/other): " )
def pythagoras():
    ...
    if which == "C":
        ...
        print("The size of side C is: ", math.sqrt(A+B))
    elif which == "B":
        A = math.pow(float(input("Please enter the value of side A: ")), 2)
        C = math.pow(float(input("Please enter the value of side C: ")), 2)
        print("The size of side B is: ", math.sqrt(math.sqrt(C)- math.sqrt(A)))
    elif which == "A":
        B = math.pow(float(input("Please enter the value of side B: ")), 2)
        C = math.pow(float(input("Please enter the value of side C: ")), 2)
        print("The size of side B is: ", math.sqrt(math.sqrt(C) - math.sqrt(B)))
    ...
    if side_or_angle == "s":
        ...
        if know == "C":
            ...
            if for_calculation == "B":
                ...
                sin = A / math.sin(a)
                print("The size of side B is: ", sin)
